...
Partial Public Class search_NayoseSaki
    ...
    Public Function CreateBodyDataSource(ByVal intRow As String) As DataTable
        ...
        dtKameitenSearchTable = CommonSearchLogic.GetNayoseSakiInfo(intRow, _
                                                                    search_Cd.Text, _
                                                                    search_Mei.Text, _
                                                                    search_Mei2.Text)
    ...
    Protected Sub MakeJavaScript()
        ...
        With csScript
            ...
            If Not IsPostBack Then
                .Append("eval('document.all.'+'" & search_Cd.ClientID & "').focus();" & vbCrLf)
            End If
            .AppendLine("       }")
    ...
    Function GetMeisai(ByVal blnSort As Boolean) As DataTable
        ...
        intRowCount = CommonSearchLogic.GetNayoseSakiCount(search_Cd.Text, _
                                                                    search_Mei.Text, _
                                                                    search_Mei2.Text)
