...
Partial Public Class KoujiKakakuMasterInput
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        blnKengen = commonChk.CommonNinnsyou(strUserID, "koj_gyoumu_kengen")
    ...
    Private Sub MakeJavascript()
        ...
        With sbScript
            ...
            .AppendLine("   window.open('KoujiKakakuMasterErrorDetails.aspx?sendSearchTerms='+strSyoriDatetime+'$$$'+encodeURIComponent(strNyuuryokuFileMei)+'$$$'+strEdiJouhouDate, 'hanbaiKakakuWindow')")
            .AppendLine("   return false;")
            .AppendLine("}")
            '「CSV取込」ボタンを押下する場合、入力チェック
            ...
            .AppendLine("   }")
            '確認メッセージ
            .AppendLine("   var strMsg = '" & Messages.Instance.MSG045C.Replace("@PARAM1", "工事価格") & "'")
    ...
    Private Sub btnCsvUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCsvUpload.Click
        ...
        Dim KojKakakuMasterLogic As New KojKakakuMasterLogic
        strErrMessage = KojKakakuMasterLogic.ChkCsvFile(Me.fupCsvUpload, strUmuFlg)
