<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/earthMaster.Master" CodeBehind="HanbaiKakakuMasterInput.aspx.vb" Inherits="Itis.Earth.WebUI.HanbaiKakakuMasterInput" 
    title="販売価格マスタ取込" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="text-align: left; width: 960px;" border="0" cellpadding="0" cellspacing="2" class="titleTable">
        <tr>
                    ...
                    <tr>
                        <td style="border:2px solid gray; border-top:none; background-color:#e6e6e6; padding-left:5px;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        <div style="width:557px; height:308px; border-bottom:solid 1px gray; overflow:auto; margin-top:-1px;">
                                            <asp:GridView ID="grdUploadKanri" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                CssClass="tableMeiSai" ShowHeader="False" CellPadding="0" Style="border-left:solid 1px gray; width:540px;">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField >
                                                        <ItemTemplate> 
                                                            <asp:label ID='lblNyuuryokuFileMei' runat="server" Text='<%#Eval("nyuuryoku_file_mei").ToString%>' ToolTip='<%#Eval("nyuuryoku_file_mei").ToString%>' Width="174px" style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis;"></asp:label>
                                                        </ItemTemplate>
