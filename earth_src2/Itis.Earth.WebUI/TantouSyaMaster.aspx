<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/earthMaster.Master" CodeBehind="TantouSyaMaster.aspx.vb" Inherits="Itis.Earth.WebUI.TantouSyaMaster" 
    title="担当者マスタメンテナンス" %>
   ...
   <asp:UpdatePanel ID="UpdatePanelA" runat="server" RenderMode="Inline" UpdateMode="Conditional">
        <ContentTemplate>
            <table id="TbHead" runat="server" cellpadding="2" class="mainTable" style="width: 472px;
                ...
                <tbody>
                    <tr>
                        <td class="koumokuMei" style="width: 94px">
                            担当者コード</td>
                        <td style="width: 96px"  > <asp:TextBox ID="tbxSyainCd" runat="server"   MaxLength="5" Style="ime-mode: disabled"
                            Width="64px"></asp:TextBox>&nbsp;
                        </td>
                        <td class="koumokuMei" style="width: 72px" >
                            担当者名</td>
                        <td>
                            <asp:TextBox ID="tbxSyainMei"  MaxLength="30" runat="server"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="koumokuMei" style="width: 94px">
                            表示区分</td>
                        <td colspan="3">
                            <asp:DropDownList ID="ddlKBN" runat="server">
                            </asp:DropDownList></td>
                    </tr>
