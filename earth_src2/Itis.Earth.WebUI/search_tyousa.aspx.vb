...
Partial Public Class search_tyousa
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ViewState("btnSelectId") = Request.QueryString("btnSelectId")
            If ViewState("btnSelectId") Is Nothing Then
                ViewState("btnSelectId") = String.Empty
            End If
            '=========2012/04/10 車龍 405738 追加↑================================
    ...
    Public Function CreateBodyDataSource(ByVal intRow As String) As DataTable
        ...
        dtKameitenSearchTable = CommonSearchLogic.GetTyousaInfo(intRow, _
                                                                    search_Cd.Text, _
                                                                    search_Mei.Text, _
                                                                    search_Mei2.Text, ViewState("blnDelete"))
    ...
    Protected Sub MakeJavaScript()
        ...
        With csScript
            ...
            .Append("function fncSetItem(objCd,strObjCd,strObjCd2,objMei,strObjMei,objCd2,FormName)" & vbCrLf)
            .Append("{" & vbCrLf)
            ...
            '=========2012/04/10 車龍 405738 追加↓================================
            If Not CStr(ViewState("btnSelectId")).Trim.Equals(String.Empty) Then
                .Append("eval('window.opener.document.all." & CStr(ViewState("btnSelectId")).Trim & "').click();" & vbCrLf)
            End If
            '=========2012/04/10 車龍 405738 追加↑================================
    ...
    Sub SetValueScript()
        ...
        With csScript
            ...
            Else
                .Append("eval('window.opener.document.all.'+'" & ViewState("objCd") & "').innerText=eval('document.all.'+'" & grdBody.Rows(0).Cells(0).ClientID & "').innerText+eval('document.all.'+'" & grdBody.Rows(0).Cells(1).ClientID & "').innerText;" & vbCrLf)
