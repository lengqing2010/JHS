...
Partial Public Class SeikyusyoExcelOutputTestPage
...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Dim strSeikyusyoNo As String = Request.QueryString("seino")
            tbx_seikyusyo_no.Text = strSeikyusyoNo
        Else
            Select Case hidSeni.Value
                Case "1" 'Excel出力
                    Dim strSeikyusyoNo As String = String.Empty
