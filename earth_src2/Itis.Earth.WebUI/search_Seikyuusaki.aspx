<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="search_Seikyuusaki.aspx.vb" Inherits="Itis.Earth.WebUI.search_Seikyuusaki" %>
         ...
         <table style="text-align: left;" class="mainTable" cellpadding="2">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="search_Cd" style="width: 107px;" runat="server">
                        </asp:DropDownList>
                        <asp:TextBox ID="search_Mei"  style="width: 80px; ime-mode: disabled;" runat="server"></asp:TextBox>-
                        <asp:TextBox ID="search_Mei2" runat="server" Style="ime-mode: disabled; width: 50px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblMei3" runat="server"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="search_Mei3" runat="server" Style="ime-mode: active; width: 500px"></asp:TextBox></td>
                </tr>
                <tr>
