...
Partial Public Class SeikyusyoFcwOutput
...
#End Region
    ...
    Private Sub CreateFcwTyouhyouData()
        ...
        'EMAB障害対応情報の格納処理
        UnTrappedExceptionManager.AddMethodEntrance(MyClass.GetType.FullName & "." _
        ...
        If seikyusyoNoDataTable.Rows.Count > 0 Then
            ...
            'DATファイル作成
            errMsg = fcw.GetErrMsg(fcw.WriteData(sb_T.ToString))
    ...
    Private Sub editDR_data_settings(ByVal seikyusyoDataTable As Data.DataTable, _
        ...
        editDR("hinmei") = seikyusyoDataTable.Rows(i).Item("hinmei").ToString.Trim & " " & _
                    seikyusyoDataTable.Rows(i).Item("irai_tantousya_mei") & " 様"
