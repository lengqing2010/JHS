<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="search_SinkaikeiJigyousyo.aspx.vb" Inherits="Itis.Earth.WebUI.search_SinkaikeiJigyousyo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
     <title>新会計事業所検索</title>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 514px">
                        <asp:TextBox MaxLength="10" ID="search_Cd" style="width: 100px; ime-mode: disabled;" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td style="width: 514px">
                        <asp:TextBox ID="search_Mei"  MaxLength="40"  style="width: 500px; ime-mode: active;" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblMei2"  MaxLength="40"  runat="server"></asp:Label></td>
                    <td style="width: 514px">
                        <asp:TextBox ID="search_Mei2"   MaxLength="20" runat="server" Style="ime-mode: active;" Width="272px"></asp:TextBox></td>
                </tr>
                <tr>
