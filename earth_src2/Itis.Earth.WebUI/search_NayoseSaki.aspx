<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="search_NayoseSaki.aspx.vb" Inherits="Itis.Earth.WebUI.search_NayoseSaki" %>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 514px">
                        <asp:TextBox MaxLength="10" ID="search_Cd"  TabIndex ="-1" style="width: 100px; ime-mode: disabled;" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td style="width: 514px">
                        <asp:TextBox ID="search_Mei"  MaxLength="40"  TabIndex ="-1"  style="width: 500px; ime-mode: active;" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td style="width: 514px">
                        <asp:TextBox ID="search_Mei2" TabIndex ="-1"  MaxLength="20" runat="server" Style="ime-mode: active;" Width="272px"></asp:TextBox></td>
                </tr>
                <tr>
