...
Partial Public Class kakakuseikyuJyouhou
    ...
    Protected Function PageItemInputCheck(ByVal btnKbn As String) As Boolean
        ...
        If btnKbn = "登録" Then
            ...
            TbxItemInputCheck(Me.tbx_ekijyouka_tokuyaku_kakaku, "液状化特約費", "半角数字", , 1)
            TbxItemInputCheck(Me.tbx_ekijyouka_tokuyaku_kakaku, "液状化特約費", "桁数", 8)


            TbxItemInputCheck(Me.tbx_ekijyouka_kanihantei_kakaku, "液状化簡易判定価格", "半角数字", , 1)
            TbxItemInputCheck(Me.tbx_ekijyouka_kanihantei_kakaku, "液状化簡易判定価格", "桁数", 8)
