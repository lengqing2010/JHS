...
Partial Public Class HanyouSiireInput
    ...
    Private Sub MakeJavascript()
        ...
        With sbScript
            ...
            .AppendLine("   window.open('HanyouSiireErrorDetails.aspx?sendSearchTerms='+strSyoriDatetime+'$$$'+encodeURIComponent(strNyuuryokuFileMei)+'$$$'+strEdiJouhouDate, 'HanyouSiireWindow')")
            .AppendLine("   return false;")
            .AppendLine("}")
            ...
            .AppendLine("   }")
            ''確認メッセージ
            '.AppendLine("   var strMsg = '" & Messages.Instance.MSG045C.Replace("@PARAM1", "汎用仕入") & "'")
    ...
    Private Sub btnCsvUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCsvUpload.Click
        ...
        If hanyouSiireBC.GetUploadKanri(Me.fupCsvUpload.FileName) > 0 Then
            With csScript
    ...
    Private Sub btnUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpload.Click
        ...
        Dim hanyouSiireBC As New HanyouSiireLogic
        strErrMessage = hanyouSiireBC.ChkCsvFile(CType(ViewState("strCsvLine"), String()), CType(ViewState("FileName"), String), strUmuFlg)
