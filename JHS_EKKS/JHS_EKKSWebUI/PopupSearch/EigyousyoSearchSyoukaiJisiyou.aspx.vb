...
''' </summary>
''' <remarks></remarks>
Partial Class PopupSearch_EigyousyoSearchSyoukaiJisiyou
    Inherits System.Web.UI.Page

#Region "プライベート変数"

    Private eigyousyoSearchSyoukaiJisiyouBC As New Lixil.JHS_EKKS.BizLogic.EigyousyoSearchSyoukaiJisiyouBC
...
#Region "イベント"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            'バラメタ
            Me.tbxEigyousyoCd.Text = Request.QueryString("strEigyousyoCdValue")
            ViewState("strTorikesi") = Request.QueryString("strTorikesi")
            ...
            'フォーカスにセットする
            Me.tbxEigyousyoCd.Focus()
        End If

        'クリアボタン
        Me.btnClear.Attributes.Add("onClick", "return fncClear('" & Me.tbxEigyousyoCd.ClientID & "','" & Me.tbxEigyousyoMei.ClientID & "','" & Me.ddlKensakuKensu.ClientID & "');")
        '閉じるボタン
    ...
    Protected Sub btnKensakuJltukou_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnKensakuJltukou.Click
        ...
        dtEigyousyoMei = eigyousyoSearchSyoukaiJisiyouBC.GetEigyousyo(Me.ddlKensakuKensu.SelectedValue, _
                                                            Me.tbxEigyousyoCd.Text, _
                                                            Me.tbxEigyousyoMei.Text, _
                                                            Convert.ToBoolean(ViewState("strTorikesi")))
        ...
        dtMeisaiCount = eigyousyoSearchSyoukaiJisiyouBC.GetEigyousyoCount(Me.tbxEigyousyoCd.Text, Me.tbxEigyousyoMei.Text, Convert.ToBoolean(ViewState("strTorikesi")))
    ...
    Protected Sub grdMeisai_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles grdMeisai.RowDataBound
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Dim lblMeisaiCd As Label = CType(e.Row.FindControl("lblEigyousyoCdValue"), Label)

            Dim strHidModuru As String = Request.QueryString("fieldHid")
            Dim strBtn As String = Request.QueryString("fieldBtn")

            'ダブルクリックする時
            e.Row.Attributes.Add("ondblclick", "fncSetItem('" & Request.QueryString("strEigyousyoMeiId") & _
                                                           "','" & Request.QueryString("strEigyousyoCdId") & _
    ...
    Protected Sub SetJyunjyo(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkBtnEigyousyoMeiUp.Click, _
                                                                                          ...
                                                                                          lnkBtnEigyousyoCdUp.Click, _
                                                                                          lnkBtnEigyousyoCdDown.Click
        ...
        Select Case lnkButton.ID.Replace("Up", "").Replace("Down", "").Replace("lnkBtn", "")
            Case "EigyousyoMei"
                strKoumoku = "eigyousyo_mei"
            Case "EigyousyoCd"
                strKoumoku = "eigyousyo_cd"
            Case Else
...
#Region "メソッド"
    ...
    Private Sub SetLink(ByVal blnLinkKbn As Boolean)
        ...
        If blnLinkKbn = True Then
            ...
            Me.lnkBtnEigyousyoCdUp.Visible = True
            Me.lnkBtnEigyousyoCdDown.Visible = True
        Else
            '"▲"と"▼"リンクは表示しない
            Me.lnkBtnEigyousyoMeiUp.Visible = False
            Me.lnkBtnEigyousyoMeiDown.Visible = False
            Me.lnkBtnEigyousyoCdUp.Visible = False
            Me.lnkBtnEigyousyoCdDown.Visible = False
        End If
    ...
    Private Sub SetLinkColor()
        ...
        Me.lnkBtnEigyousyoCdUp.Style.Add("color", "SkyBlue")
        Me.lnkBtnEigyousyoCdDown.Style.Add("color", "SkyBlue")
    ...
    Private Sub SetValueScript()
        ...
        With csScript
            ...
            .AppendLine("}else")
            .AppendLine("{")
            If Not Request.QueryString("strEigyousyoMeiId").Trim.Equals(String.Empty) Then
                .AppendLine("    eval('window.opener.'+'" & Request.QueryString("formName") & "'+'.'+'" & Request.QueryString("strEigyousyoMeiId") & "').innerText='" & CType(Me.grdMeisai.Rows(0).FindControl("lblEigyousyoMeiValue"), Label).Text & "';")
            End If
            .AppendLine("    eval('window.opener.'+'" & Request.QueryString("formName") & "'+'.'+'" & Request.QueryString("strEigyousyoCdId") & "').innerText='" & CType(Me.grdMeisai.Rows(0).FindControl("lblEigyousyoCdValue"), Label).Text & "';")
            .AppendLine("    window.close();")
            .AppendLine("}")
