...
CodeFile="KeikakuKanriInput.aspx.vb" Inherits="KeikakuKanriInput" title="計画管理 CSV取込" %>
                    ...
                    <tr>
                        <td style="border: 2px solid gray; border-top: none; background-color: #e6e6e6; text-align: center;">
                            <table border="0" cellpadding="0" cellspacing="0" style="margin-top: 20px;">
                                ...
                                <tr>
                                    <td>
                                        <uc1:CommonButton ID="btnCsvInput" runat="server"  Text ="計画CSV取込" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 15px;">
                                        <asp:TextBox ID="hidCsvKbn" style="display:none"  runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </td>
