...
#Region "定数"
    ...
    Private Const CON_FORMAT As String = "###,###,###,###,###,##0."
...
#Region "変数"
    ...
    Private _DecimalLength As Integer = 1                       '小数桁数
    ...
    Public Property Value() As String
        ...
        Set(ByVal value As String)
            ...
            Else
                ...
                For i As Integer = 1 To DecimalLength
                    strFormat = strFormat & "#"
                Next
                If IsNumeric(value) Then
                    strValue = Format(Convert.ToDecimal(value.Replace(",", "")), CON_FORMAT & strFormat)
    ...
    Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
        ...
        If Not MyBase.Text = "" Then
            ...
            If IsNumeric(Me.Value) Then
                strValue = Format(Convert.ToDecimal(Me.Value), CON_FORMAT & strFormat)
                MyBase.Text = Me.LeftFormat & strValue & Me.RightFormat
...
#Region "メンッド"
    ...
    Private Sub SetAttributes()
        ...
        'フォーカスアウト
        Me.Attributes("onfocusout") = "if(readOnly==true){return true;}if(!focusoutFlg){return true;}if(!SetDecimalFocusOut(this,'" & ObjName & "','" & LeftFormat & "','" & RightFormat & "','" & DecimalLength & "')){return false;}" & _
                                      Me.Attributes("onfocusout")

        'Enter
        Me.Attributes("onkeypress") = "if ((event.keyCode>=48 && event.keyCode<=57) || event.keyCode == 46){}else{return false;}" & _
