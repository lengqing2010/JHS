...
Public Class BukkenRirekiRecord
...
#Region "履歴種別"
    ...
    ''' <remarks></remarks>
    <TableMap("rireki_syubetu", IsKey:=False, IsInsert:=True, IsUpdate:=True, SqlType:=SqlDbType.VarChar, SqlLength:=2)> _
...
#Region "履歴NO"
    ...
    ''' <remarks></remarks>
    <TableMap("rireki_no", IsKey:=False, IsInsert:=True, IsUpdate:=True, SqlType:=SqlDbType.Int, SqlLength:=4)> _
...
#Region "内容"
    ...
    ''' <returns> 内容</returns>
    ''' <remarks></remarks>
    <TableMap("naiyou", IsKey:=False, IsInsert:=True, IsUpdate:=True, SqlType:=SqlDbType.VarChar, SqlLength:=512)> _
...
#Region "汎用日付"
    ...
    ''' <remarks></remarks>
    <TableMap("hanyou_date", IsKey:=False, IsInsert:=True, IsUpdate:=True, SqlType:=SqlDbType.DateTime, SqlLength:=16)> _
...
#Region "汎用コード"
    ...
    ''' <remarks></remarks>
    <TableMap("hanyou_cd", IsKey:=False, IsInsert:=True, IsUpdate:=True, SqlType:=SqlDbType.VarChar, SqlLength:=20)> _
...
#Region "取消"
    ...
    ''' <returns> 取消</returns>
    ''' <remarks></remarks>
    <TableMap("torikesi", IsKey:=False, IsInsert:=True, IsUpdate:=False, SqlType:=SqlDbType.Int, SqlLength:=4)> _
