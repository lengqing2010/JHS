...
''' </summary>
''' <remarks></remarks>
Public Class MousikomiKeyRecord
...
#Region "調査会社未決定"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private intTysKaisyaSearchTaisyou As Integer = Integer.MinValue
    ''' <summary>
    ''' 調査会社未決定
    ''' </summary>
    ''' <value></value>
    ''' <returns> 調査会社未決定</returns>
    ''' <remarks></remarks>
    Public Property TysKaisyaSearchTaisyou() As String
        Get
            Return intTysKaisyaSearchTaisyou
        End Get
        Set(ByVal value As String)
            intTysKaisyaSearchTaisyou = value
        End Set
    End Property
#End Region
