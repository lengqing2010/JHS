<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SearchEigyousyo.aspx.vb"
    Inherits="Itis.Earth.WebUI.SearchEigyousyo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>EARTH 営業所検索</title>
</head>
...
<script type="text/javascript">
    ...
    function funcAfterAllClear(obj){
        ...
        objEBI("<%= eigyousyoCd.clientID %>").focus();
    }
...
<body>
            ...
            <tbody>
                <tr>
                    <td>
                        営業所コード</td>
                    <td>
                        <input size="100" id="eigyousyoCd" maxlength="5" style="width: 100px; ime-mode: disabled;"
                            runat="server" />
                ...
                <tr>
                    <td>
                        営業所カナ名</td>
                    <td>
                        <input size="100" id="eigyousyoKanaNm" maxlength="40" style="width: 500px; ime-mode: active;"
                            runat="server" /></td>
                </tr>
                <tr>
    ...
    <div class="dataGridHeader" id="dataGridContent">
        <table class="scrolltablestyle" cellpadding="0" cellspacing="0" style="width: 420px">
            <thead>
