<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/EarthMasterPage.Master"
    Codebehind="SearchHannyouUriage.aspx.vb" Inherits="Itis.Earth.WebUI.SearchHannyouUriage"
    Title="EARTH 汎用売上データ照会" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var objDenpyouUriDateFrom = null;
        var objDenpyouUriDateTo = null;
        ...
        *********************************************/
        ...
        function PopupSyuusei(strUniqueNo){    
            ...
            //オープン対象の画面を指定
            varAction = "<%=UrlConst.HANNYOU_URIAGE_SYUUSEI %>";
            ...
            var varWindowName = "HannyouUriageSyuusei";
        ...
        *********************************************/
        function setGlobalObj() {
            ...
            objDenpyouUriDateFrom = objEBI("<%= TextDenpyouUriageDateFrom.clientID %>");
            objDenpyouUriDateTo = objEBI("<%= TextDenpyouUriageDateTo.clientID %>");
        ...
        */
        ...
        function checkJikkou(){
            ...
            //伝票売上年月日 大小チェック
            if(!checkDaiSyou(objDenpyouUriDateFrom,objDenpyouUriDateTo,"伝票売上年月日"))return false;
        ...
        <tbody>
            <tr>
                <th style="text-align: left; width: 160px;">
                    汎用売上データ照会</th>
                <th>
                    <input id="ButtonSinki" value="新規登録" type="button" runat="server" onclick="PopupSyuusei(0)"
                        tabindex="10" />&nbsp;&nbsp;
                ...
                <td colspan="4">
                    <asp:UpdatePanel ID="UpdatePanel_syouhin" UpdateMode="Conditional" runat="server"
                        ...
                        <ContentTemplate>
                            ...
                            <input id="TextHinmei" runat="server" class="readOnlyStyle" readonly="readonly" style="width: 350px"
                                tabindex="-1" />&nbsp;
                    ...
                    <asp:UpdatePanel ID="UpdatePanel_seikyuu" UpdateMode="Conditional" runat="server"
                        ...
                        <ContentTemplate>
                            ...
                            <input id="btnSeikyuuSakiSearch" runat="server" type="button" value="検索" class="gyoumuSearchBtn"
                                onserverclick="btnSeikyuuSakiSearch_ServerClick" tabindex="30" />&nbsp;
            ...
            <tr>
                ...
                <td class="date" colspan="2">
                    <input id="TextSeikyuuDateFrom" runat="server" maxlength="10" class="date" onblur="checkDate(this);"
                        tabindex="40" />&nbsp;～&nbsp;<input id="TextSeikyuuDateTo" runat="server" maxlength="10"
                ...
                <td class="date">
                    <input id="TextUriageDateFrom" runat="server" maxlength="10" class="date" onblur="checkDate(this);"
                        tabindex="40" />&nbsp;～&nbsp;<input id="TextUriageDateTo" runat="server" maxlength="10"
                            class="date" onblur="checkDate(this);" tabindex="40" /></td>
            </tr>
            <tr>
                <td class="koumokuMei">
                ...
                <td class="koumokuMei">
                    番号</td>
                <td colspan="2">
                    <asp:TextBox ID="TextHosyousyoNo" runat="server" MaxLength="10" Style="width: 72px;"
                        CssClass="codeNumber" TabIndex="50" />
                </td>
                <td class="koumokuMei">
                    伝票売上年月日</td>
                <td class="date">
                    <input id="TextDenpyouUriageDateFrom" runat="server" maxlength="10" class="date" onblur="checkDate(this);"
                        tabindex="50" />&nbsp;～&nbsp;<input id="TextDenpyouUriageDateTo" runat="server" maxlength="10"
