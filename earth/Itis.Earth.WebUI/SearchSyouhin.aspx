<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SearchSyouhin.aspx.vb"
    Inherits="Itis.Earth.WebUI.SearchSyouhin" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>EARTH 商品検索</title>
</head>
...
<script type="text/javascript">
    ...
    function funcAfterAllClear(obj){
        ...
        objEBI("<%= search_shouhinCd.clientID %>").focus();
    }
...
<body>
    <form method="post" id="mstSearch" runat="server">
            ...
            <tbody>
                <tr>
                    <td>
                        商品コード</td>
                    <td>
                        <input size="100" id="search_shouhinCd" maxlength="8" style="width: 100px; ime-mode: disabled;"
                            runat="server" /></td>
                </tr>
                <tr>
                    <td>
                        商品名</td>
                    <td>
                        <input size="100" id="search_shouhinKanaNm" maxlength="40" style="width: 500px; ime-mode: active;"
                            runat="server" /></td>
                </tr>
                <tr>
        ...
        <input id="search_shouhin23" runat="server" type="hidden" /></form>
