Public Partial Class SearchMousikomi
    ...
    '申込データ検索ロジッククラス
    Dim MyLogic As New MousikomiSearchLogic
    '申込データ検索KEYレコードクラス
    Private keyRec As New MousikomiKeyRecord
    '申込データレコードクラス
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            If pStrKbn IsNot Nothing OrElse pStrHosyousyoNo IsNot Nothing Then
                ...
                Me.SelectStatus.SelectedIndex = 1
...
#Region "プライベートメソッド"
    ...
    ''' <remarks></remarks>
    Private Sub SetSearchKeyFromCtrl(ByRef recKey As MousikomiKeyRecord)
        ...
        '調査会社未決定]
        keyRec.TysKaisyaSearchTaisyou = IIf(Me.CheckTysKaisyaSearchTaisyou.Checked, 0, Integer.MinValue)
    ...
    Private Sub SetSearchResult(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        '検索実行
        Dim resultArray As New List(Of MousikomiRecord)
        ...
        Dim objTdMousikomiNo As HtmlTableCell           '申込NO
        ...
        Dim objTdTysHouhou As HtmlTableCell             '調査方法

        '取得したデータを画面に表示
        For Each data As MousikomiRecord In resultArray
            rowCnt += 1
            ...
            objTdMousikomiNo = New HtmlTableCell            '申込NO
            ...
            objTdTysHouhou = New HtmlTableCell              '調査方法
            ...
            objTdMousikomiNo.InnerHtml = cl.GetDisplayString(strMousikomiNo, strSpace)
            ...
            objTdTysHouhou.InnerHtml = cl.GetDisplayString(data.TysHouhouMei, strSpace)

            '各セルの幅設定
            If rowCnt = 1 Then
                objTdTaisyou.Style("width") = widthList1(0)
                objTdMousikomiNo.Style("width") = widthList1(1)
                ...
                objTdJyuusyo1.Style("width") = widthList2(0)
                objTdJyuusyo2.Style("width") = widthList2(1)
                objTdKameitenCd.Style("width") = widthList2(2)
                objTdKameitenMei.Style("width") = widthList2(3)
                objTdIraiDate.Style("width") = widthList2(4)
                objTdSyouhinCd.Style("width") = widthList2(5)
                objTdSyouhinMei.Style("width") = widthList2(6)
                objTdDoujiIraiTousuu.Style("width") = widthList2(7)
                objTdSesyuMeiUmu.Style("width") = widthList2(8)
                objTdTysHouhou.Style("width") = widthList2(9)
            End If

            'スタイル、クラス設定
            objTdTaisyou.Attributes("class") = CSS_TEXT_CENTER
            objTdMousikomiNo.Attributes("class") = CSS_TEXT_CENTER
            ...
            objTdTysHouhou.Attributes("class") = ""
...
#Region "DB更新処理系"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Function GetCtrlToDataList() As List(Of MousikomiRecord)
        Dim listRec As New List(Of MousikomiRecord)
        Dim dtRec As New MousikomiRecord
        ...
        If arrKeyMousikomiNo.Length = arrKeyUpdDatetime.Length Then
            If Not arrKeyMousikomiNo Is Nothing And Not arrKeyUpdDatetime Is Nothing Then
                ...
                For intCnt = 0 To arrKeyMousikomiNo.Length - 1
                    ...
                    End If
                    ' 調査会社未決定チェックボックス
                    dtRec.TysKaisyaTaisyou = Me.CheckTysKaisyaTaisyou.Checked
