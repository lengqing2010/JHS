<%@ Control Language="vb" AutoEventWireup="false" Codebehind="TeibetuNyuukinRecordCtrlTop.ascx.vb"
    Inherits="Itis.Earth.WebUI.TeibetuNyuukinRecordCtrlTop" %>
<tr runat="server" id="trTop">
    <td class="koumokuMei" runat="server" id="tdTitle">
    ...
    <td>
        <asp:UpdatePanel ID="UpdatePanelSyouhin" runat="server" RenderMode="Inline" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <asp:HiddenField ID="HiddenZangaku" runat="server" />
            </ContentTemplate>
            <Triggers>
