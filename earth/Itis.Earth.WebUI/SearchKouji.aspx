<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SearchKouji.aspx.vb"
    Inherits="Itis.Earth.WebUI.SearchKouji" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>EARTH 工事会社検索</title>
</head>
...
<body>
    <form method="post" id="mstSearch" runat="server">
            ...
            <tbody>
                <tr>
                    <td>
                        工事会社コード</td>
                    <td>
                        <input size="100" id="TextCode" maxlength="7" style="width: 100px; ime-mode: disabled;"
                            runat="server" /></td>
                </tr>
                <tr>
                    <td>
                        工事会社カナ名</td>
                    <td>
                        <input size="100" id="TextName" maxlength="20" style="width: 500px; ime-mode: active;"
                            runat="server" /></td>
                </tr>
                <tr>
        ...
        <input id="KameitenCd" type="hidden" runat="server" /></form>
