<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/EarthMasterPage.Master"
    Codebehind="SeikyuuSakiMototyou.aspx.vb" Inherits="Itis.Earth.WebUI.SeikyuuSakiMototyou"
    Title="EARTH 請求先元帳表示・出力画面" %>
    ...
    <script type="text/javascript">
        ...
        *********************************************/
        function setGlobalObj() {
            //画面表示部品
            objSeikyuuSakiMei = objEBI("<%= TextSeikyuuSakiMei.clientID %>")
                        ...
                        <tr>
                            ...
                            <td class="codeNumber hissu">
                                <asp:UpdatePanel ID="UpdatePanel_seikyuu" UpdateMode="Conditional" runat="server"
                                    RenderMode="Inline">
                                    <ContentTemplate>
                                        <asp:DropDownList ID="SelectSeikyuuKbn" runat="server">
                                        </asp:DropDownList>
