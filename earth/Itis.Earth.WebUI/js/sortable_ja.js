...
function ts_makeSortable(t) {
	...
	for (var i=0;i<firstRow.cells.length;i++) {
		...
		if (cell.className != "unsortable" && cell.className.indexOf("unsortable") == -1) {
		    ...
		    cell.style.width = cell.clientWidth + 14;
			cell.innerHTML = '<a href="#" class="sortheader" onclick="ts_resortTable(this.parentNode, '+i+');return false;" tabindex="-1">'+txt+'</a><span class="sortarrow"><img src="'+ image_path + image_none + '" alt="&darr;"/></span>';
		}
	}
